...
#### What kind of inheritance strategies are a# Enterprise module (Java branch)
...
#### What kind of inheritance strategies are available? Which annotations are used to solve this?vailable? Which annotations are used to solve this?